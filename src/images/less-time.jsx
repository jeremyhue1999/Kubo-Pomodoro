  ...
  return (
    ...
    >
      <svg viewBox="0 0 42 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M18 34C9.16344 34 2 26.8366 2 18C2 9.16344 9.16344 2 18 2" stroke={svgFill} stroke-width="4"/>
        <path d="M18 34C26.8366 34 34 26.8366 34 18" stroke={svgFill}  stroke-width="4"/>
