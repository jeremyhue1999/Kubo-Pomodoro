                ...
                <div className="relative p-4 max-w-2xl h-auto md:w-full sm:w-min md:h-auto">
                    ...
                    <div className="relative bg-white shadow-xl shadow-gray-600 dark:bg-[#EB3C27]">
                        ...
                        <div className="flex justify-center items-center p-5 rounded-t border-b dark:border-gray-600">
                            <img className="logo object-cover w-40 h-fit" src={require("../images/logo-dark.png" )}></img>
                        </div>
                        ...
                        <div className="flex flex-col bg-gray-300">
                            ...
                            <form className='pt-6 justify-center -space-y'>
                                    <div className="rounded-md shadow-sm -space-y-px mr-12 ml-12 pb-4">
                                        ...
                                        <div>
                                            <button type="button" className="w-full justify-center my-2 text-white bg-[#087830] hover:bg-white hover:text-black focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55  mb-2 " onClick={handleSendCode}>
                                                Send Code
                                            </button>
